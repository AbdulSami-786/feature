...
const GLASS_OPTIONS = [
  { id: "/glass1.png", name: "Classic", price: "PKR 4,500", emoji: "👓", sizes: [{ label: "XL", scale: 1.10, mobileScale: 0.68 }] },
  { id: "/glass2.png", name: "Aviator", price: "PKR 5,200", emoji: "🕶️", sizes: [{ label: "L", scale: 1.15, mobileScale: 1.02 }] },
  { id: "/glass3.png", name: "Sport", price: "PKR 3,800", emoji: "🥽", sizes: [{ label: "L", scale: 1.15, mobileScale: 1.02 }] },
  { id: "/glass4.png", name: "Round", price: "PKR 4,900", emoji: "⭕", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass5.png", name: "Wayfarer", price: "PKR 4,900", emoji: "🕶️", sizes: [{ label: "L", scale: 1.25, mobileScale: 1.0 }] },
  { id: "/glass6.png", name: "Vintage", price: "PKR 4,900", emoji: "🪩", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass7.png", name: "Clubmaster", price: "PKR 4,900", emoji: "🔲", sizes: [{ label: "XL", scale: 1.30, mobileScale: 1.12 }] },
  { id: "/glass8.png", name: "Cat Eye", price: "PKR 4,900", emoji: "😼", sizes: [{ label: "XL", scale: 1.30, mobileScale: 1.12 }] },
  { id: "/glass9.png", name: "Shield", price: "PKR 4,900", emoji: "🛡️", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.78 }] },
  { id: "/glass10.png", name: "Oval", price: "PKR 4,900", emoji: "🥚", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass11.png", name: "Square", price: "PKR 4,900", emoji: "⬛", sizes: [{ label: "S", scale: 0.75, mobileScale: 0.55 }] },
  { id: "/glass12.png", name: "Hexagonal", price: "PKR 4,900", emoji: "⬡", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass13.png", name: "Geometric", price: "PKR 4,900", emoji: "🔷", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.78 }] },
  { id: "/glass14.png", name: "Steampunk", price: "PKR 4,900", emoji: "⚙️", sizes: [{ label: "S", scale: 0.95, mobileScale: 0.55 }] },
  { id: "/glass15.png", name: "Sports Pro", price: "PKR 4,900", emoji: "🏃", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass16.png", name: "Retro", price: "PKR 4,900", emoji: "🎞️", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass17.png", name: "Modern", price: "PKR 4,900", emoji: "✨", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass18.png", name: "Luxury", price: "PKR 4,900", emoji: "💎", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass19.png", name: "Designer", price: "PKR 4,900", emoji: "🎨", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass20.png", name: "Classic II", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass21.png", name: "Classic III", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.78 }] },
  { id: "/glass22.png", name: "Classic IV", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.05, mobileScale: 0.95 }] },
  { id: "/glass23.png", name: "Classic V", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass24.png", name: "Classic VI", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "S", scale: 0.85, mobileScale: 0.55 }] },
  { id: "/glass25.png", name: "Classic VII", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass26.png", name: "Classic VIII", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass27.png", name: "Classic IX", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass28.png", name: "Classic X", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.78 }] },
  { id: "/glass29.png", name: "Classic XI", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.25, mobileScale: 0.98 }] },
  { id: "/glass30.png", name: "Classic XII", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass31.png", name: "Classic 31", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass32.png", name: "Classic 32", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass33.png", name: "Classic 33", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass34.png", name: "Classic 34", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass35.png", name: "Classic 35", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "M", scale: 1.10, mobileScale: 0.78 }] },
  { id: "/glass36.png", name: "Classic 36", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass37.png", name: "Classic 37", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass38.png", name: "Classic 38", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "XL", scale: 1.30, mobileScale: 1.12 }] },
  { id: "/glass39.png", name: "Classic 39", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass40.png", name: "Classic 40", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.78 }] },
  { id: "/glass41.png", name: "Classic 41", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass42.png", name: "Classic 42", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "S", scale: 0.95, mobileScale: 0.55 }] },
  { id: "/glass43.png", name: "Classic 43", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass44.png", name: "Classic 44", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
  { id: "/glass45.png", name: "Classic 45", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "XL", scale: 1.30, mobileScale: 1.12 }] },
  { id: "/glass46.png", name: "Classic 46", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "XL", scale: 1.40, mobileScale: 1.12 }] },
  { id: "/glass47.png", name: "Classic 47", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "XL", scale: 1.20, mobileScale: 1.12 }] },
  { id: "/glass48.png", name: "Classic 48", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "M", scale: 1.00, mobileScale: 0.78 }] },
  { id: "/glass49.png", name: "Classic 49", price: "PKR 4,900", emoji: "👓", sizes: [{ label: "L", scale: 1.15, mobileScale: 0.98 }] },
];
...
const MOBILE_EMA_ALPHA = 0.62; // Higher for better responsiveness
const MOBILE_ANGLE_ALPHA = 0.45; // Stronger smoothing for rotation
const MOBILE_DEADZONE = 0.6; // Reduced deadzone for finer movements
const MOBILE_FPS = 28;
const MOBILE_FRAME_INT = 1000 / MOBILE_FPS;
...
// Enhanced Adaptive Smoother for mobile
class AdaptiveLandmarkSmoother {
  constructor(posAlpha = 0.62, rotAlpha = 0.45) {
    this.posAlpha = posAlpha;
    this.rotAlpha = rotAlpha;
    this.prev = null;
    this.velocity = { cx: 0, cy: 0, gw: 0, gh: 0, angle: 0 };
    this.stableCount = 0;
    this.lastStable = null;
  }
  
  smooth(current, deadzone = 0.6, deltaTime = 16) {
    if (!this.prev) {
      this.prev = { ...current };
    ...
    const speed = Math.hypot(
      (current.cx - this.prev.cx) / deltaTime,
      (current.cy - this.prev.cy) / deltaTime
    );
    // Adaptive alpha: faster response for large movements, stronger smoothing for small
    const adaptivePosAlpha = Math.min(0.8, Math.max(0.5, this.posAlpha * (1 + speed / 20)));
    
    for (const key of Object.keys(current)) {
      const alpha = key === "angle" ? this.rotAlpha : adaptivePosAlpha;
      let delta = current[key] - this.prev[key];
      
      // Update velocity for prediction
      this.velocity[key] = this.velocity[key] * 0.6 + delta * 0.4;
      
      // Deadzone: ignore very small movements to reduce jitter
      if (deadzone > 0 && Math.abs(delta) < deadzone) {
        result[key] = this.prev[key];
      } else {
        // Apply prediction for smoother tracking
        const predicted = this.prev[key] + this.velocity[key] * 0.2;
        const smoothed = this.prev[key] + alpha * delta;
        result[key] = smoothed * 0.65 + predicted * 0.35;
      }
      
      // Clamp values to reasonable ranges
      if (key === 'gw') result[key] = Math.max(80, Math.min(480, result[key]));
      if (key === 'gh') result[key] = Math.max(40, Math.min(280, result[key]));
      if (key === 'angle') result[key] = Math.max(-0.5, Math.min(0.5, result[key]));
    }
    
    // Stability check - if movement is very small, increment stable counter
    const movement = Math.hypot(
      (result.cx - this.lastStable.cx) || 0,
      (result.cy - this.lastStable.cy) || 0
    );
    if (movement < 3) {
      this.stableCount++;
      if (this.stableCount > 5) {
        // Use last stable position to prevent drift
        result.cx = this.lastStable.cx;
        result.cy = this.lastStable.cy;
        result.angle = this.lastStable.angle;
      }
    } else {
      this.stableCount = 0;
...
// Enhanced face geometry extraction for mobile
function extractFaceGeometryMobile(lm, W, H) {
  const px = (idx) => ({ x: lm[idx].x * W, y: lm[idx].y * H, z: lm[idx].z ?? 0 });
  ...
  // Use stable landmarks only (no iris on mobile)
  const leftEyeOuter = px(LANDMARKS.LEFT_EYE_OUTER);
  const rightEyeOuter = px(LANDMARKS.RIGHT_EYE_OUTER);
  const leftEyeInner = px(LANDMARKS.LEFT_EYE_INNER);
  const rightEyeInner = px(LANDMARKS.RIGHT_EYE_INNER);
  const leftBrowLower = avgPx(LANDMARKS.LEFT_EYEBROW_LOWER);
  const rightBrowLower = avgPx(LANDMARKS.RIGHT_EYEBROW_LOWER);
  const noseBridgeTop = px(LANDMARKS.NOSE_BRIDGE_TOP);
  const leftFaceEdge = px(LANDMARKS.LEFT_FACE_EDGE);
  ...
  // Face width based on face edges - key for proper scaling
  const faceWidth = dist(leftFaceEdge, rightFaceEdge);
  
  // Eye centers (midpoint of inner and outer corners)
  const leftEyeCenter = {
  ...
  // Simplified rotation - use eye corners only for stability
  ...
  const browCenter = { x: (leftBrowLower.x + rightBrowLower.x) / 2, y: (leftBrowLower.y + rightBrowLower.y) / 2 };
  
  // Weighted center: eyes 45%, nose 40%, brows 15%
  const centerX = eyeCenterX * 0.45 + noseBridgeTop.x * 0.4 + browCenter.x * 0.15;
  const centerY = eyeCenterY * 0.45 + noseBridgeTop.y * 0.4 + browCenter.y * 0.15;
  
  // Dynamic glasses sizing based on face width (0.6 to 0.75 of face width)
  const faceWidthRatio = Math.min(0.75, Math.max(0.6, faceWidth / (eyeSpan * 3.5)));
  const glassesWidth = faceWidth * faceWidthRatio;
  const glassesHeight = glassesWidth * 0.55; // Aspect ratio maintenance
  
  // Depth simulation based on face width change over time
  const depthScale = Math.min(1.08, Math.max(0.92, 1 + (faceWidth / 400 - 1) * 0.3));
  
  return { 
    centerX, centerY, angle, 
    glassesWidth, glassesHeight, 
    depthScale, faceWidth,
    eyeSpan 
  };
}

// Desktop uses iris refinement
function extractFaceGeometryDesktop(lm, W, H, useIris = true) {
  const px = (idx) => ({ x: lm[idx].x * W, y: lm[idx].y * H, z: lm[idx].z ?? 0 });
...
const TryOn = () => {
  ...
  const lowConfidenceCounter = useRef(0);
  const lastStableState = useRef(null);
  ...
  const smootherRef = useRef(null);
  if (!smootherRef.current) {
    smootherRef.current = new AdaptiveLandmarkSmoother(
      isMobile ? MOBILE_EMA_ALPHA : 0.50,
      isMobile ? MOBILE_ANGLE_ALPHA : 0.40
    );
  }
  ...
  // Draw loop with improved mobile tracking
  const drawLoop = useCallback(() => {
    rafIdRef.current = requestAnimationFrame(drawLoop);
    ...
    const deltaTime = Math.min(50, now - (lastTimestampRef.current || now));
    ...
    if (!result.multiFaceLandmarks?.length) {
      smootherRef.current.reset();
      trackRef.current.hasLandmarks = false;
      lowConfidenceCounter.current++;
      // Keep last stable position for up to 10 frames to prevent flicker
      if (lowConfidenceCounter.current < 10 && lastStableState.current) {
        const img = imgRef.current;
        if (img.complete && img.naturalWidth) {
          const glassObj = cachedGlassObjRef.current;
          const sSc = glassObj?.sizes?.[0] ? getSizeScale(glassObj.sizes[0], mobile) : 1.0;
          const adj = adjRef.current[glassesRef.current] || DEFAULT_ADJ;
          let w = lastStableState.current.gw * adj.scaleW * sSc;
          let h = lastStableState.current.gh * adj.scaleH * sSc;
          const mirroredAngle = -lastStableState.current.angle;
          ctx.save();
          ctx.translate(lastStableState.current.cx + adj.offsetX, lastStableState.current.cy + adj.offsetY);
          ctx.rotate(mirroredAngle + adj.rotate * Math.PI / 180);
          ctx.drawImage(img, -w / 2, -h / 2, w, h);
          ctx.restore();
        }
    ...
    lowConfidenceCounter.current = 0;
    trackRef.current.hasLandmarks = true;

    const lm = result.multiFaceLandmarks[0];
    
    // Use different extraction based on device
    const geo = mobile 
      ? extractFaceGeometryMobile(lm, W, H)
      : extractFaceGeometryDesktop(lm, W, H, true);

    // Mirror coordinates for canvas
    const mirroredCx = W - geo.centerX;
    ...
    // Store stable state
    lastStableState.current = { ...smoothed };
    ...
    // Apply depth scaling for desktop, mobile uses dynamic scaling
    let w = smoothed.gw * adj.scaleW * sSc;
    let h = smoothed.gh * adj.scaleH * sSc;
    
    if (mobile && geo.depthScale) {
      w *= geo.depthScale;
      h *= geo.depthScale;
    }

    const mirroredAngle = -smoothed.angle;

    ctx.save();
    ctx.translate(smoothed.cx + adj.offsetX, smoothed.cy + adj.offsetY);
    ctx.rotate(mirroredAngle + adj.rotate * Math.PI / 180);
    ctx.drawImage(img, -w / 2, -h / 2, w, h);
    ctx.restore();
  ...
  useEffect(() => {
    ...
    faceMesh.setOptions({
      maxNumFaces: 1,
      refineLandmarks: !mobile,
      minDetectionConfidence: mobile ? 0.4 : 0.50,
  ...
  // MOBILE LAYOUT (unchanged UI, only tracking improved)
  if (isMobile) {
    const idx = GLASS_OPTIONS.findIndex(g => g.id === glasses);
    const { canvasW, canvasH } = mobileSizes;

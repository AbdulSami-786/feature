...
function extractFaceGeometry(lm, W, H) {
  ...
  const centerY = browCenterY * 0.4 + noseBridgeTop.y * 0.6;
...
const TryOn = () => {
  ...
  const currentGlass = GLASS_OPTIONS.find(g => g.id === glasses) || GLASS_OPTIONS[0];
              ...
              <div style={{ padding: "16px 20px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
                  <div>
                    ...
                    <div style={{ fontSize: "18px", fontWeight: 600 }}>{currentGlass?.brand || "Gucci"} {currentGlass?.model || "GG01840"}</div>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: "12px", color: "rgba(255,255,255,0.4)" }}>PRICE</div>
                    <div style={{ fontSize: "20px", fontWeight: 700, color: "#c9a84c" }}>{currentGlass?.price || "PKR 4,500"}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
                ...
                {SIZE_OPTIONS.map(size => (
                  <button
                    ...
                    style={{
                      ...
                      height: "48px",
                      borderRadius: "24px",
                      background: selectedSize === size ? "#c9a84c" : "rgba(255,255,255,0.05)",
                      border: selectedSize === size ? "none" : "1px solid rgba(255,255,255,0.1)",
                      color: selectedSize === size ? "#000" : "rgba(255,255,255,0.7)",
                      fontSize: "14px",
                      fontWeight: 600,
                      cursor: "pointer",
                    }}
              ...
              {showFitGuide && (
                <div style={{ marginTop: "12px", padding: "12px", background: "rgba(201,168,76,0.1)", borderRadius: "16px", fontSize: "12px", color: "rgba(255,255,255,0.7)" }}>
                  📏 Upload a photo or use the camera to get your perfect fit recommendation.
                </div>
              )}
            </div>
          ...
          <div style={{ display: "flex", gap: "16px", overflowX: "auto", paddingBottom: "8px" }}>
            {GLASS_OPTIONS.map(g => (
              <button
                ...
                style={{
                  minWidth: "100px",
                  background: glasses === g.id ? "rgba(201,168,76,0.15)" : "rgba(255,255,255,0.03)",
                  border: glasses === g.id ? "1px solid #c9a84c" : "1px solid rgba(255,255,255,0.08)",
                  borderRadius: "20px",
                  padding: "12px",
                  cursor: "pointer",
                  transition: "all 0.2s",
